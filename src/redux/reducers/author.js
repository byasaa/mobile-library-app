...
const author = (state = initialState, action) => {
  switch (action.type) {
    ...
    case 'POST_ADD_AUTHOR_FULFILLED':
      return {
        ...state,
        isLoading: true,
        isError: false,
    ...
    case 'PUT_UPDATE_AUTHOR_PENDING':
      return {
        ...state,
        isLoading: true,
        isError: false,
    ...
    case 'PUT_UPDATE_AUTHOR_REJECTED':
      return {
        ...state,
        isLoading: false,
        isError: true,
    ...
    case 'PUT_UPDATE_AUTHOR_FULFILLED':
      return {
        ...state,
        isLoading: true,
        isError: false,
